...
xcopy /y .\Sources\BikeEquipmentManager_en.qm %DEST_DIR%\debug
xcopy /y .\Sources\BikeEquipmentManager_fr.qm %DEST_DIR%\debug
...
xcopy /y .\Sources\BikeEquipmentManager_en.qm %DEST_DIR%\release
xcopy /y .\Sources\BikeEquipmentManager_fr.qm %DEST_DIR%\release

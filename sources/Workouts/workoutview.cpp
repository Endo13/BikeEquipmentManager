    ...
    ui(new Ui::WorkoutView)
{
	...
	_model->setHeaderData(2, Qt::Horizontal, QObject::tr("Velo utilise"));	
	_model->setHeaderData(5, Qt::Horizontal, QObject::tr("Type de sortie"));
	_model->setHeaderData(4, Qt::Horizontal, QObject::tr("Date"));
	_model->setHeaderData(3, Qt::Horizontal, QObject::tr("Meteo"));
	_model->setHeaderData(6, Qt::Horizontal, QObject::tr("Distance (km)"));
	_model->setHeaderData(7, Qt::Horizontal, QObject::tr("Duree"));
	_model->setHeaderData(8, Qt::Horizontal, QObject::tr("Denivele (m)"));
	...
	_model->setHeaderData(14, Qt::Horizontal, QObject::tr("Frequence moyenne"));
	_model->setHeaderData(15, Qt::Horizontal, QObject::tr("Frequence max"));
	_model->setHeaderData(16, Qt::Horizontal, QObject::tr("Cadence moyenne"));
	_model->setHeaderData(17, Qt::Horizontal, QObject::tr("Cadence max")); 
